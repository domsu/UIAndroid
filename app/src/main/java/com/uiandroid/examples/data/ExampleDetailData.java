...
public class ExampleDetailData {
    ...
    public final static ExampleDetail[] data = new ExampleDetail[]{
            new ExampleDetail("Reveal effect with custom color", "http://uiandroid.com/reveal-effect-custom-color/", Build.VERSION_CODES.LOLLIPOP, RevealCustomColorActivity.class)
    };
